...
use Tutor\BunnyNetIntegration\Integration\BunnyApi;
...
class BunnySettings {
    ...
    public function registerSettings() {
        ...
        add_settings_field(
            ...
            __('Library Creation', 'tutor-lms-bunnynet-integration'),
        ...
        add_settings_field(
            ...
            __('Manual Video Creation', 'tutor-lms-bunnynet-integration'),
    ...
    public function renderSettingsPage() {
        ...
        submit_button(__('Save Settings', 'tutor-lms-bunnynet-integration'));
        echo "</form>";
    }
    ...
    public function handleManualVideoCreationAjax() {
        ...
        if (empty($title) || empty($library_id)) {
            wp_send_json_error(['message' => __('Title or Library ID is missing.', 'tutor-lms-bunnynet-integration')], 400);
        }
        ...
        if (isset($response['guid'])) {
            ...
            wp_send_json_success([
                'message' => __('Video object created successfully.', 'tutor-lms-bunnynet-integration'),
            ]);            
        } else {
            error_log('Failed to create video object. Response: ' . print_r($response, true));
            wp_send_json_error(['message' => __('Failed to create video object.', 'tutor-lms-bunnynet-integration')], 500);
        }
    }        
    ...
    public function handleCreateLibraryAjax() {
        ...
        if (isset($response['guid'])) {
            ...
            wp_send_json_success([
                'message' => __('Library created successfully.', 'tutor-lms-bunnynet-integration'),
